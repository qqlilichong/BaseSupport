...
{
public:
	inline HRESULT CreateDevice( _In_ IDirect3D9Ex* pD3D9,
		_In_ HWND hWnd,
		_In_ UINT nAdapter,
	...
	{
		return m_d3d9_device->PresentEx( NULL, NULL, NULL, NULL, D3DPRESENT_FORCEIMMEDIATE ) ;
	}
	...
	inline operator IDirect3DDevice9Ex* ()
	{
		return m_d3d9_device ;
	}
...
inline BOOL WSL2_D3D9_EnumMonitor( _In_ IDirect3D9Ex* pD3D9, LPD3D9_EnumMonitor_Callback pCallBack, _In_ LPVOID pv )
{
